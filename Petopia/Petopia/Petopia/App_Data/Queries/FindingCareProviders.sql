...
select PetopiaUsers.UserID as PU_ID, PetopiaUsers.IsProvider, PetopiaUsers.FirstName, PetopiaUsers.LastName, PetopiaUsers.ResZipcode,
		CareProvider.CareProviderID as CP_ID,
